...
A user can use the mecanum drive kinematics classes in order to perform [odometry](./#what-is-odometry). WPILib/SolversLib contains a `MecanumDriveOdometry` class that can be used to track the position of a mecanum drive robot on the field.
