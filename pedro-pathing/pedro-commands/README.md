...
One of SolversLib's modern features is easy integration with [Pedro Pathing](https://pedropathing.com/), a popular path following library for Autonomous. To use this, make sure you have both the [pedroPathing module installed](../../installation.md#build.gradle-teamcode) as well as the [Pedro Pathing library installed](https://pedropathing.com/prerequisites.html#project-setup). This dependency is completely seperate from core, meaning that it is not installed by default, and should only be used if you are using Pedro Pathing.
